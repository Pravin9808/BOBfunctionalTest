...
public class BOBHLcalculator extends BaseClass {
	...
	@Test(priority=0)
	public void axisPlCalAmortisation() throws InterruptedException, IOException  {
		...
		for (int i = 2; i <=inpRowCount+1; i++) {
				XSSFRow currentrow = inpSheet.getRow(i);
				 ...
				 DataFormatter formatter = new DataFormatter();
					...
					WebElement rateofInterestTextBoxElement = driver.findElement(By.xpath("//em[normalize-space()='8.40']"));
